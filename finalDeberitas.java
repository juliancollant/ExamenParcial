...
public class HospitalMain {
    ...
    public static void mostrarPacientes(Connection connection) {
        try {
            String consulta = "SELECT p.id, p.nombre as nombre_paciente, p.edad, p.fecha_ingreso, d.nombre as nombre_doctor, p.sintomasMedicos FROM pacientes p INNER JOIN doctores d ON p.doctor = d.id";
            ...
            while (resultSet.next()) {
                ...
                String nombre = resultSet.getString("nombre_paciente");
                int edad = resultSet.getInt("edad");
                String fechaIngreso = resultSet.getString("fecha_ingreso");
                String doctor = resultSet.getString("nombre_doctor");
    ...
    public static String obtenerEspecialidad(int opcion) {
        switch (opcion) {
            case 1:
                return "Cardiología";
            case 2:
